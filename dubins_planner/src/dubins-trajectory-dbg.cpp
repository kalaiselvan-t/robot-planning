...
int main(){
	...
	std::cout << "pidx: " << pidx << "\n";
	std::cout << "==============================================="<< std::endl;
	std::cout << "a1.x0: " << dubin_curve.a1.x0 << std::endl;
	std::cout << "a1.y0: " << dubin_curve.a1.y0 << std::endl;
	std::cout << "a1.th0: " << dubin_curve.a1.th0 << std::endl;
	std::cout << "a1.k: " << dubin_curve.a1.k << std::endl;
	std::cout << "a1.l: " << dubin_curve.a1.l << std::endl;
	std::cout << "a1.xf: " << dubin_curve.a1.xf << std::endl;
	std::cout << "a1.yf: " << dubin_curve.a1.yf << std::endl;
	std::cout << "a1.thf: " << dubin_curve.a1.thf << std::endl;
	std::cout << "==============================================="<< std::endl;
	std::cout << "a2.x0: " << dubin_curve.a2.x0 << std::endl;
	std::cout << "a2.y0: " << dubin_curve.a2.y0 << std::endl;
	std::cout << "a2.th0: " << dubin_curve.a2.th0 << std::endl;
	std::cout << "a2.k: " << dubin_curve.a2.k << std::endl;
	std::cout << "a2.l: " << dubin_curve.a2.l << std::endl;
	std::cout << "a2.xf: " << dubin_curve.a2.xf << std::endl;
	std::cout << "a2.yf: " << dubin_curve.a2.yf << std::endl;
	std::cout << "a2.thf: " << dubin_curve.a2.thf << std::endl;
	std::cout << "==============================================="<< std::endl;
	std::cout << "a3.x0: " << dubin_curve.a3.x0 << std::endl;
	std::cout << "a3.y0: " << dubin_curve.a3.y0 << std::endl;
	std::cout << "a3.th0: " << dubin_curve.a3.th0 << std::endl;
	std::cout << "a3.k: " << dubin_curve.a3.k << std::endl;
	std::cout << "a3.l: " << dubin_curve.a3.l << std::endl;
	std::cout << "a3.xf: " << dubin_curve.a3.xf << std::endl;
	std::cout << "a3.yf: " << dubin_curve.a3.yf << std::endl;
	std::cout << "a3.thf: " << dubin_curve.a3.thf << std::endl;
	std::cout << "==============================================="<< std::endl;
	std::cout << "L: " << dubin_curve.L << std::endl;
}
