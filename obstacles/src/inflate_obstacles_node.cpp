...
// Class to subscribe to the obstacles published
class ObstaclesSubscriber: public rclcpp::Node
{
    ...
    private:
            ...
            ()
        {
            ...
            cout << "size: " << polygon_list.size() << endl;
            cout << "=======================\n"; 
            // cout << "Obstcales array received\n";
            // for
            //     (size_t i = 0; i < msg.obstacles.size(); i++)
            // {
            //     for 
            //         (size_t j = 0; j < msg.obstacles[i].polygon.points.size(); j++)
            //     {
            //         cout << "x: " << msg.obstacles[i].polygon.points[j].x << " y: " << msg.obstacles[i].polygon.points[j].y << "z: " << msg.obstacles[i].polygon.points[j].z << endl;
            //         // cout << "points size: " << msg.obstacles[i].polygon.points.size() << endl;
            //         // cout << "j: " << msg.obstacles[i].polygon.points.size() << endl;
            //     }
            //     cout << "-------------------------------\n";
            // }
        }
