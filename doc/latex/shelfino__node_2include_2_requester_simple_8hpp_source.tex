\hypertarget{shelfino__node_2include_2_requester_simple_8hpp_source}{}\doxysection{Requester\+Simple.\+hpp}
\label{shelfino__node_2include_2_requester_simple_8hpp_source}\index{X:/shelfino\_node/include/RequesterSimple.hpp@{X:/shelfino\_node/include/RequesterSimple.hpp}}
...
\DoxyCodeLine{20 }
\DoxyCodeLine{21 \textcolor{keyword}{class }RequesterSimple \{}
...
\DoxyCodeLine{28 }
\DoxyCodeLine{29     \textcolor{keyword}{typedef} \textcolor{keyword}{struct }\_req\_ \{}
\DoxyCodeLine{30       std::string rcvd;}
\DoxyCodeLine{31       status\_t status;}
\DoxyCodeLine{32 }
\DoxyCodeLine{33       \_req\_(): rcvd(\textcolor{stringliteral}{"{}"{}}), status(STATUS\_OK) \{\}}
\DoxyCodeLine{34     \} request\_t;}
\DoxyCodeLine{35 }
\DoxyCodeLine{36     RequesterSimple(std::string address);}
\DoxyCodeLine{37     \textcolor{keyword}{virtual} \string~RequesterSimple();}
\DoxyCodeLine{38 }
\DoxyCodeLine{39     }
