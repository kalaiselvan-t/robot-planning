\hypertarget{remote__control_2include_2single__thread_8hpp_source}{}\doxysection{single\+\_\+thread.\+hpp}
\label{remote__control_2include_2single__thread_8hpp_source}\index{X:/remote\_control/include/single\_thread.hpp@{X:/remote\_control/include/single\_thread.hpp}}
...
\DoxyCodeLine{21 }
\DoxyCodeLine{22 \textcolor{keyword}{class }\mbox{\hyperlink{class_common_1_1single__thread}{single\_thread}} \{}
...
\DoxyCodeLine{27 }
\DoxyCodeLine{28     \mbox{\hyperlink{class_common_1_1single__thread}{single\_thread}}(\textcolor{keyword}{const} std::string\& thread\_name = \textcolor{stringliteral}{"{}single\_thread"{}}) :}
\DoxyCodeLine{29         alive(\textcolor{keyword}{false}), terminating(\textcolor{keyword}{false}), joined(\textcolor{keyword}{true}),}
\DoxyCodeLine{30         exception\_thrown(\textcolor{keyword}{false}), default\_tout\_ms(60000),}
...
\DoxyCodeLine{35     \}}
\DoxyCodeLine{36 }
\DoxyCodeLine{37     \mbox{\hyperlink{class_common_1_1single__thread}{single\_thread}}(thread\_fun\_t f, \textcolor{keyword}{const} std::string\& thread\_name) :}
\DoxyCodeLine{38         alive(\textcolor{keyword}{false}), terminating(\textcolor{keyword}{false}), joined(\textcolor{keyword}{true}),}
\DoxyCodeLine{39         exception\_thrown(\textcolor{keyword}{false}), default\_tout\_ms(60000),}
\DoxyCodeLine{40         thread\_name(thread\_name), custom\_worker(f) \{}
\DoxyCodeLine{41           custom\_terminating\_callback = []()\{\};}
\DoxyCodeLine{42     \}}
\DoxyCodeLine{43 }
\DoxyCodeLine{44     \mbox{\hyperlink{class_common_1_1single__thread}{single\_thread}}(thread\_fun\_t f, terminating\_fun\_t ft, \textcolor{keyword}{const} std::string\& thread\_name) :}
\DoxyCodeLine{45         alive(\textcolor{keyword}{false}), terminating(\textcolor{keyword}{false}), joined(\textcolor{keyword}{true}),}
\DoxyCodeLine{46         exception\_thrown(\textcolor{keyword}{false}), default\_tout\_ms(60000),}
...
\DoxyCodeLine{147 }
\DoxyCodeLine{148     \textcolor{keyword}{virtual} \mbox{\hyperlink{class_common_1_1single__thread}{\string~single\_thread}}() \{stop();\}}
\DoxyCodeLine{149 }
